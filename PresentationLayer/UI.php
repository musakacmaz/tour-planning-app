 ...
 * Time: 12:01
 */
    require_once (__DIR__."/../LogicLayer/AdminManager.php");
...
<!---->
<div class="banner-bg">
    <video autoplay="autoplay" muted="muted" poster="resources/wall_icons/my.jpg" width="100%"  loop>
        <source src="resources/srix.mp4" type="video/mp4">
    </video>
    <div class="banner">
        <div class="header">
            <div class="logo wow fadeInLeft" data-wow-delay="0.5s">
                <a href="/../index.php"><img src="resources/images/logo2.png" alt=""/></a>
            </div>
            <div class="top-menu">
...
<div id="brief" class="brief">
    <div class="container">
        <div class="col-md-6 brief-grids wow fadeInLeft" data-wow-delay="0.5s">
            <img src="resources/images/browse.jpg" alt=""/>
            <div class="brief-grid">
                <div class="brief-grid-text">
                    <h3>TRAVEL DOCUMENTS</h3>
                    <p>Travelo® is the world's largest travel site*, enabling travelers to unleash the potential of every trip. Travelo offers advice from millions of travelers, with 500 million reviews and opinions covering 7 million accommodations and a wide variety of travel choices and planning features — checking more than 200 websites to help travelers find and book today's lowest hotel prices. Travelo branded sites make up the largest travel community in the world, reaching 390 million average unique monthly visitors** in 49 markets worldwide. Travelo: Know better. Book better. Go better.
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6 brief-grids wow fadeInRight" data-wow-delay="0.5s">
            <img src="resources/images/browse2.jpg" alt=""/>
            <div class="brief-grid">
                <div class="brief-grid-text">
                    <h3>Describe what we are Provide</h3>
                    <p>At Travelo, we believe in the power of travel — and in helping you make the most of every trip. With over 500 million candid traveler reviews, we can help you make the right choice when you shop for hotels, restaurants, and attractions. You'll also find low airfares, free travel guides, worldwide vacation rental listings, popular forums with advice about virtually every destination, and more. When it’s time to book, we can help you save up to 30% on hotels, checking 200+ sites to find you today’s lowest prices.
                    </p>
                </div>
            </div>
        </div>
...
<div id="features" class="features">
    <div class="container">
        <div class="feature-text text-center">
            <h3>Features</h3>
            <p>Here are some facilities of our system.</p>
        </div>
        <div class="features-section">
            <div class="col-md-6 feature-grid text-center">
                <i class="f1 wow bounceIn" data-wow-delay="0.5s"></i>
                <h3>Easy to Customize</h3>
                <p>Choose your dream travel from our various options.</p>
            </div>
            <div class="col-md-6 feature-grid text-center">
                <i class="f2 wow bounceIn" data-wow-delay="0.5s"></i>
                <h3>Travel Documents</h3>
                <p>Details about our travels are clearly described.</p>
            </div>
            <div class="clearfix"></div>
            <div class="col-md-6 feature-grid text-center">
                <i class="f3 wow bounceIn" data-wow-delay="0.5s"></i>
                <h3>Visa Support</h3>
                <p>You can complete payment easily by using credit card.</p>
            </div>
            <div class="col-md-6 feature-grid text-center">
                <i class="f4 wow bounceIn" data-wow-delay="0.5s"></i>
                <h3>Consultation</h3>
                <p>Our customer services ready to help you 24/7.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="video">
    <div class="container">
        <div class="video-text text-center">
            <h3>Watch Video</h3>
            <p>Just in case if you need some motivation.</p>
        </div>
        <div class="video-grids">
            ...
            <div class="col-md-4 video-right">
                ...
                <div id="small-dialog" class="mfp-hide">
                    <iframe src="https://player.vimeo.com/video/40301191" frameborder="0" allowfullscreen></iframe>
                </div>
...
<div id="screenshots" class="screenshots">
    <div class="container">
        <div class="screen-text text-center">
            <h3>Recent Tours</h3>
            <p>This perfect places are just several clicks away from you.</p>
        </div>
        ...
        <div id="owl-demo" class="owl-carousel">
            <div class="item text-center guide-sliders">
                <div class="col-md-4 image-grid">
                    <img src="resources/images/sc1.jpg">
                </div>
                <div class="col-md-4 image-grid">
                    <img src="resources/images/sc2.jpg">
                </div>
                <div class="col-md-4 image-grid">
                    <img src="resources/images/sc3.jpg">
                </div>
            </div>
            <div class="item text-center guide-sliders">
                <div class="col-md-4 image-grid">
                    <img src="resources/images/sc4.jpg">
                </div>
                <div class="col-md-4 image-grid">
                    <img src="resources/images/sc5.jpg">
                </div>
                <div class="col-md-4 image-grid">
                    <img src="resources/images/sc1.jpg">
                </div>
...
<div id="testimonial" class="trusted">
    <div class="container">
        <div class="trusted-text text-center">
            ...
            <p>Some feedbacks of our customers from all over the world.</p>
        </div>
        <div class="box-grids">
            <div class="col-md-4 client wow fadeInLeft" data-wow-delay="0.5s">
                <div class="box-grid">
                    <span></span>
                    <p>Travelo was an amazing experience! I have completed my booking just a few minutes.</p>
                    <label></label>
                </div>
                <h4><a href="#">Tony Parker</a></h4>
                <p class="ceo">France</p>
            </div>
            <div class="col-md-4 client wow fadeInUp" data-wow-delay="0.5s">
                <div class="box-grid">
                    <span></span>
                    <p>Best tour planning website on the internet. Our vacation was perfect! Thank you Travelo.</p>
                    <label></label>
                </div>
                <h4><a href="#">Manu Ginobili</a></h4>
                <p class="ceo">Argentina</p>
            </div>
            <div class="col-md-4 client wow fadeInRight" data-wow-delay="0.5s">
                <div class="box-grid">
                    <span></span>
                    <p>If you're looking for a great holiday, all you need is Travelo. It's user-friendly, fast and stable.</p>
                    <label></label>
                </div>
                <h4><a href="#">Patty Mills</a></h4>
                <p class="ceo">New Zealand</p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
...
<div class="get-started">
    <div class="container">
        ...
        <a href="PresentationLayer/AdminLogin.php">ADMIN LOGIN</a>
    </div>
</div>
<!---->
<!---728x90--->
<div id="contact" class="contact">
    <div class="container">
        <div class="contact-text text-center">
            <h3>Contact</h3>
            <p>Get in touch with us whenever you want.</p>
        </div>
        ...
        <div class="map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d29644.290138204957!2d27.203634362383543!3d38.38372340210175!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x22aca51dc55ea9d1!2zRG9rdXogRXlsw7xsIMOcbml2ZXJzaXRlc2kgQmlsZ2lzYXlhciBNw7xoZW5kaXNsacSfaSBCw7Zsw7xtw7w!5e0!3m2!1str!2str!4v1495837745405" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
    </div>
</div>
<!---->
<div class="footer">
    <div class="container">
        <div class="ftr-logo">
            <a class="wow bounceIn" data-wow-delay="0.5s" href="/../index.php"><img src="resources/images/logo2.png" alt=""/></a>
        </div>
        <div class="copy-right wow bounceInUp" data-wow-delay="0.5s">
            <p>Copyright &#169; 2017 Travelo . All Rights Reserved.</p>
        </div>
...
<a href="#to-top" id="toTop" style="display: block;"> <span id="toTopHover" > </span></a>
<!---->
</body>
</html>
